  ...
  <div id="classnotice">
    ...
    <div class="seach">
      <div class="seach_left">
        <el-input placeholder="请输入标题关键字(回车搜索)" v-model="keywordsVal" suffix-icon="el-icon-search" clearable @change="keyWordsInput">
        </el-input>
      </div>
    ...
    <!-- 表格 -->
    <el-table :data="tableData.data" style="width: 100%" height="600px" :header-cell-style="{textAlign:'center'}" :cell-style="{textAlign:'center',color:'#606266',padding:'4px 0'}">
      ...
      <el-table-column prop="createTime" label="发布时间">
        <template slot-scope="scope">
          ...
          <span style="margin-left: 10px">{{ scope.row.createTime?new Date(scope.row.createTime).format('yyyy-MM-dd hh:mm'):"无" }}</span>
        </template>
      </el-table-column>
    ...
    <pageHtml :tabObj.sync='tableData' name="classNotice" :type='noticeValue' :keywords='keywordsVal'></pageHtml>
