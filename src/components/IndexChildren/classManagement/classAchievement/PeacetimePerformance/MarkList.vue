  ...
  <div id="MarkList">
    ...
    >
      ...
      <el-table-column prop="passRate" label="及格率(60%)" width="100">
        <template slot-scope="scope">
          <span style="margin-left: 10px">{{ scope.row.passRate}}</span>
        </template>
      </el-table-column>
      <el-table-column prop="goodRate" label="优良率(80%)" width="100">
        <template slot-scope="scope">
          <span style="margin-left: 10px">{{ scope.row.goodRate}}</span>
        </template>
      </el-table-column>
      <el-table-column prop="isSend" label="是否已发给家长" width="120">
        <template slot-scope="scope">
          <span style="margin-left: 10px">{{ scope.row.isSend==true?"是":'否'}}</span>
        </template>
      </el-table-column>
