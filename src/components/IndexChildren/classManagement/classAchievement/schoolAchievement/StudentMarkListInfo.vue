 ...
 * -----
 * Last Modified: Friday, 23rd November 2018 6:08:01 pm
 ...
 <template>
  <div id="PerformanceDivisionManagement">
    ...
    <el-dialog :visible.sync="dialogVisible2" top="30vh" width="30%">
      <div slot="title" style="text-align:center;">
        是否将{{tableData.data?tableData.data[0].subjectName:null}}成绩和评价内容发送给家长？包括以下内容：
      </div>
    ...
    <pageHtml :tabObj.sync='tableData' name="classStudentSubjectScoreClassStudentSubjectScoreList" :otherType='queryObj' :searchsKey='keywordsVal' :edit='true'></pageHtml>
  </div>
</template>
